...
export function createFmsgSendTool(
  ...
  return {
    ...
    description:
      "Send an fmsg message to an @user@domain address, continuing the most recent 1:1 thread unless fmsg_new_thread is true.",
    ...
    execute: async (
      ...
      if (!to || !text) throw new Error("fmsg_send requires to and text");
