...
export function resolveFmsgConfig(cfg, env = process.env) {
    ...
    return {
        ...
        maxAgentTurnsPerRoot: envInteger("FMSG_MAX_AGENT_TURNS_PER_ROOT", env.FMSG_MAX_AGENT_TURNS_PER_ROOT, 0) ??
            raw.maxAgentTurnsPerRoot ??
            DEFAULT_MAX_AGENT_TURNS_PER_ROOT,
        maxAgentTurnsPerSender: envInteger("FMSG_MAX_AGENT_TURNS_PER_SENDER", env.FMSG_MAX_AGENT_TURNS_PER_SENDER, 0) ??
